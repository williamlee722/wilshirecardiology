...
export default function Angina() {
        ...
        <div className="row">
            ...
            <div className="row">
                <div className="col-3 col-lg-3 aboutHeader physicians-sidebar">
                    ...
                    <a href='/wilshirecardiology/#/services/treatments/angina'><button className='sidebar-button sidebar-items selected'>Angina</button></a>
  ...
  <path d="M8.051 1.999h.089c.822.003 4.987.033 6.11.335a2.01 2.01 0 0 1 1.415 1.42c.101.38.172.883.22 1.402l.01.104.022.26.008.104c.065.914.073 1.77.074 1.957v.075c-.001.194-.01 1.108-.082 2.06l-.008.105-.009.104c-.05.572-.124 1.14-.235 1.558a2.007 2.007 0 0 1-1.415 1.42c-1.16.312-5.569.334-6.18.335h-.142c-.309 0-1.587-.006-2.927-.052l-.17-.006-.087-.004-.171-.007-.171-.007c-1.11-.049-2.167-.128-2.654-.26a2.007 2.007 0 0 1-1.415-1.419c-.111-.417-.185-.986-.235-1.558L.09 9.82l-.008-.104A31.4 31.4 0 0 1 0 7.68v-.123c.002-.215.01-.958.064-1.778l.007-.103.003-.052.008-.104.022-.26.01-.104c.048-.519.119-1.023.22-1.402a2.007 2.007 0 0 1 1.415-1.42c.487-.13 1.544-.21 2.654-.26l.17-.007.172-.006.086-.003.171-.007A99.788 99.788 0 0 1 7.858 2h.193zM6.4 5.209v4.818l4.157-2.408L6.4 5.209z"/>
                ...
                <div className="col-12 col-lg-9 portfolio">
                    <div className="row">
                        <div className="col-12 col-lg-12 physicianTitle">Angina</div>
                        <div className="col-12 col-lg-12">
                            <p className='treatmentP'>Angina is chest pain or pressure caused by decreased blood flow to the heart. Pain may also be felt in the arms, jaw, or upper back. The pain can be a signal that the heart is not getting enough oxygen. It is a sign of treatment needed to prevent a heart attack.<br/><br/></p>
                            <p className='treatmentRedEmphises'>Angina can happen anytime, but is more common with:</p>
                            <ul>
                                <li>Work, exercise or activity</li>
                                <li>Eating a large meal</li>
                                <li>Smoking or using tobacco</li>
                                <li>Very hot or cold temperatures</li>
                                <li>Emotional or stressful events</li>
                            </ul>
                            <p className='treatmentRedEmphises'>Symptoms</p>
                            <p>Signs of Angina are much like the signs of a heart attack.</p>
                            <ul>
                                <li>Pain or pressure, a feeling of tightness or heaviness in the chest, arms, jaw, shoulders or neck</li>
                                <li>Shortness of breath</li>
                                <li>Nausea or vomiting</li>
                                <li>Abdominal pain</li>
                                <li>Feeling very tired, dizzy, or faint</li>
                                <li>Some people have no signs</li>
                            </ul>
                            <p>Angina will often ease when you stop what you are doing and rest. If a doctor has told you that you have angina, you may be given medicine to take when you have pain. The medicine is called nitroglycerin.</p>
                            <p className='treatmentRedEmphises'>When to Seek Treatment</p>
                            <p>Call 911 if you:</p>
                            <ul>
                                <li>Are having signs and do not have medicine to treat angina.</li>
                                <li>Have taken medicine, but the signs are not going away or have new signs that you have not had before.</li>
                                <li>Sit or lie down until the emergency team arrives. Do not drive to the hospital or delay by calling your doctor.</li>
                            </ul>
                            <p className='treatmentRedEmphises'>Care</p>
                            <p>You will be tested to see if you a heart problem. You may be prescribed medicine or have other procedures to improve blood flow to your heart. Your doctor may also advise you to eat a low fat diet and exercise to improve heart health. If your doctor prescribes nitroglycerin, use the medicine as directed. Talk to a doctor about your care or any questions you have.</p>
                        </div>
                    </div>
                </div>
            </div>
