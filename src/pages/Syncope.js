...
export default function Syncope() {
  return (
        ...
        <div className="row">
            ...
            <div className="row">
                ...
                <h5>Services</h5>
                    ...
                    <a href='/wilshirecardiology/#/services/treatments/syncope'><button className='sidebar-button sidebar-items selected'>Syncope</button></a>
  ...
  <path d="M8.051 1.999h.089c.822.003 4.987.033 6.11.335a2.01 2.01 0 0 1 1.415 1.42c.101.38.172.883.22 1.402l.01.104.022.26.008.104c.065.914.073 1.77.074 1.957v.075c-.001.194-.01 1.108-.082 2.06l-.008.105-.009.104c-.05.572-.124 1.14-.235 1.558a2.007 2.007 0 0 1-1.415 1.42c-1.16.312-5.569.334-6.18.335h-.142c-.309 0-1.587-.006-2.927-.052l-.17-.006-.087-.004-.171-.007-.171-.007c-1.11-.049-2.167-.128-2.654-.26a2.007 2.007 0 0 1-1.415-1.419c-.111-.417-.185-.986-.235-1.558L.09 9.82l-.008-.104A31.4 31.4 0 0 1 0 7.68v-.123c.002-.215.01-.958.064-1.778l.007-.103.003-.052.008-.104.022-.26.01-.104c.048-.519.119-1.023.22-1.402a2.007 2.007 0 0 1 1.415-1.42c.487-.13 1.544-.21 2.654-.26l.17-.007.172-.006.086-.003.171-.007A99.788 99.788 0 0 1 7.858 2h.193zM6.4 5.209v4.818l4.157-2.408L6.4 5.209z"/>
                ...
                <div className="col-12 col-lg-9 portfolio">
                    <div className="row">
                        <div className="col-12 col-lg-12 physicianTitle">Syncope</div>
                        <div className="col-12 col-lg-12">
                            <p className='treatmentP'>Syncope is a temporary loss of consciousness and posture, described as fainting or passing out. Usually related to temporary insufficient blood flow to the brain, it most often occurs when the blood pressure is too low &#40;hypotension&#41; and the heart doesn't pump a normal supply of oxygen to the brain. </p>
                            <p>What causes syncope may be emotional stress, pain, pooling of blood in the legs due to sudden changes in body position, overheating, dehydration, heavy sweating or exhaustion. Syncope may occur during violent coughing spells &#40;especially in men&#41; because of rapid changes in blood pressure. It also may result from several heart, neurologic, psychiatric, metabolic and lung disorders. And it may be a side effect of some medicines. Some forms of syncope suggest a serious disorder: Occuring with exercise.</p>
                            <p>Syncope is associated with palpitations or irregularities of the heart and/or family history of recurrent syncope or sudden death.</p>
                            <p>Other tests, such as exercise stress test, Holter monitor, echocardiogram, etc., may be needed to rule out other cardiac causes of syncope. If EKG and cardiac tests are normal, the person will undergo a tilt test. The blood pressure and heart rate will be measured while lying down on a board and after the board is tilted up. Someone who has NMS will usually faint during the tilt, due to the rapid drop in blood pressure and heart rate. As soon as the person is placed on his or her back again, blood flow and consciousness are restored.</p>
                            <p>To help prevent syncope, people with NMS should be on a higher-salt diet &#40;this is recommended only for persons diagnosed with NMS&#41; and drink plenty of fluids to avoid dehydration and maintain blood volume. They should watch for the warning signs of fainting - dizziness, nausea and sweaty palms - and sit or lie down if they feel the warning signs. Some people also may need medication.</p>
